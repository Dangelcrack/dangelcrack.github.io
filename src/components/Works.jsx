    ...
    return (
        <>
            ...
            <div className="w-full flex">
                ...
                >
                    Estos son proyectos personales que he construido y desplegado por mi cuenta, con backend en
                    Python/Django y Java, junto a mi experiencia profesional en Qanet desarrollando con
                    Laravel y PHP. Cada uno resuelve un problema real y está corriendo en producción, no solo
                    en local.
                </motion.p>
            </div>
